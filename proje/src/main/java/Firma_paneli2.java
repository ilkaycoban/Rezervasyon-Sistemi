...
public class Firma_paneli2 extends javax.swing.JFrame {


    public Firma_paneli2() {
        initComponents();
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Company company = new Company("B", "123b");
        ...
        if(a<7&&a>-1)
        {
        int c= company.giderhesapla(2);
        int b = ilkay.gelirhesapla(a, 2);
        int d = b-c;   
        String eren = Integer.toString(d+60000);
       
        JOptionPane.showMessageDialog(Firma_paneli2.this,(a+4)+" Aralık tarihindeki karınız: "+eren);
        }
        else
        JOptionPane.showMessageDialog(Firma_paneli2.this,"Lütfen geçerli gün giriniz!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Firma_paneli2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Firma_paneli2().setVisible(true);
            }
        });
    }
