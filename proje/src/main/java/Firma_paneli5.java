...
public class Firma_paneli5 extends javax.swing.JFrame {

    /**
     * Creates new form Firma_paneli5
     */
    public Firma_paneli5() {
        initComponents();
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Company company = new Company("F", "123f");
        ...
        if(a<7&&a>-1)
        {
        int c= company.giderhesapla(5);
        int b = ilkay.gelirhesapla(a, 5);
        int d = b-c;   
        String eren = Integer.toString(d);
       
        JOptionPane.showMessageDialog(Firma_paneli5.this,(a+4)+" Aralık tarihindeki karınız: "+eren);
        }
        else
        JOptionPane.showMessageDialog(Firma_paneli5.this,"Lütfen geçerli gün giriniz!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Firma_paneli5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Firma_paneli5().setVisible(true);
            }
        });
    }
