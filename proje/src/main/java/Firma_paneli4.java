...
public class Firma_paneli4 extends javax.swing.JFrame {

    /**
     * Creates new form Firma_paneli4
     */
    public Firma_paneli4() {
        initComponents();
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       Company company = new Company("D", "123d");
        ...
        if(a<7&&a>-1)
        {
        int c= company.giderhesapla(4);
        int b = ilkay.gelirhesapla(a, 4);
        int d = b-c;   
        String eren = Integer.toString(d);
       
        JOptionPane.showMessageDialog(Firma_paneli4.this,(a+4)+" Aralık tarihindeki karınız: "+eren);
        }
        else
        JOptionPane.showMessageDialog(Firma_paneli4.this,"Lütfen geçerli gün giriniz!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Firma_paneli4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Firma_paneli4().setVisible(true);
            }
        });
    }
